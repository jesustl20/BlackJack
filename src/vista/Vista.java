...
public class Vista extends JFrame {
	...
	public List<JLabel> jlabelsDealer = new ArrayList();
	public List<JLabel> jlabelsJugador = new ArrayList();
	...
	public Vista() {
		...
		jlabelsDealer.add(lbl1);
		jlabelsDealer.add(lbl2);
		jlabelsDealer.add(lbl3);
		jlabelsDealer.add(lbl4);
		jlabelsDealer.add(lbl5);
		jlabelsDealer.add(lbl6);
		jlabelsDealer.add(lbl7);
		jlabelsDealer.add(lbl8);
		jlabelsDealer.add(lbl8);
		jlabelsDealer.add(lbl9);
		jlabelsDealer.add(lbl10);
		jlabelsDealer.add(lbl11);
		jlabelsDealer.add(lbl12);
		...
		jlabelsJugador.add(lbl13);
		jlabelsJugador.add(lbl14);
		jlabelsJugador.add(lbl15);
		jlabelsJugador.add(lbl16);
		jlabelsJugador.add(lbl17);
		jlabelsJugador.add(lbl18);
		jlabelsJugador.add(lbl19);
		jlabelsJugador.add(lbl20);
		jlabelsJugador.add(lbl21);
		jlabelsJugador.add(lbl22);
		jlabelsJugador.add(lbl23);
		jlabelsJugador.add(lbl24);
		...
		start.setBounds(1162, 553, 89, 23);
